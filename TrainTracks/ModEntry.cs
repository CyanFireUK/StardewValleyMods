...
namespace TrainTracks
{
    ...
    public partial class ModEntry : Mod
    {
        ...
        public override void Entry(IModHelper helper)
        {
            ...
            harmony.Patch(
               original: AccessTools.Method(typeof(Flooring), nameof(Flooring.draw), new Type[] { typeof(SpriteBatch)}),
        ...
        private void OnAssetRequested(object sender, AssetRequestedEventArgs e)
        {
            ...
            if (e.Name.IsEquivalentTo("Mods/aedenthorn.TrainTracks/TrainFront"))
            {
                e.LoadFromModFile<Texture2D>("assets/horse_front.png", AssetLoadPriority.Medium);

            }

            if (e.Name.IsEquivalentTo("Mods/aedenthorn.TrainTracks/Tracks"))
            {
                e.LoadFromModFile<Texture2D>("assets/tracks.png", AssetLoadPriority.Medium);

            }

            if (e.Name.IsEquivalentTo("Mods/aedenthorn.TrainTracks/Blank"))
            {
                e.LoadFromModFile<Texture2D>("assets/blank.png", AssetLoadPriority.Medium);
        ...
        private void Input_ButtonPressed(object sender, StardewModdingAPI.Events.ButtonPressedEventArgs e)
        {
            ...
            if (e.Button == Config.PlaceTrainKey && Game1.player.mount == null && Game1.player.currentLocation.terrainFeatures.TryGetValue(Game1.currentCursorTile, out TerrainFeature feature) && feature is Flooring && feature.modData.TryGetValue(trackKey, out string indexString) && int.TryParse(indexString, out int index))
            {
                ...
                Horse horse = new Horse(Guid.NewGuid(), (int)feature.Tile.X, (int)feature.Tile.Y) { Name = "Mods/TrainTracks/Train", modData = { [trainKey] = "true" } };
