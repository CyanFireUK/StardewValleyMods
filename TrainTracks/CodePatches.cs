...
namespace TrainTracks
{
    ...
    public partial class ModEntry
    {
        ...
        {
            if (!Config.EnableMod || !__instance.modData.ContainsKey(trainKey) || frontTexture == null || backTexture == null)
                return;
        ...
        private static bool Flooring_performToolAction_Prefix(Flooring __instance, Tool t, int damage, Vector2 tileLocation, ref bool __result)
        {
            ...
            {
                Game1.createRadialDebris(location, 14, (int)tileLocation.X, (int)tileLocation.Y, 4, false, -1, false, null);
